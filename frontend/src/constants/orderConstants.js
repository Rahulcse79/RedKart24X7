...
export const PAYMENT_RAZORPAY_STATUS_REQUEST = "PAYMENT_RAZORPAY_STATUS_REQUEST";
export const PAYMENT_RAZORPAY_STATUS_SUCCESS = "PAYMENT_RAZORPAY_STATUS_SUCCESS";
export const PAYMENT_RAZORPAY_STATUS_FAIL = "PAYMENT_RAZORPAY_STATUS_FAIL";

export const PAYMENT_RAZORPAY_VERIFY_STATUS_REQUEST = "PAYMENT_RAZORPAY_VERIFY_STATUS_REQUEST";
export const PAYMENT_RAZORPAY_VERIFY_STATUS_SUCCESS = "PAYMENT_RAZORPAY_VERIFY_STATUS_SUCCESS";
export const PAYMENT_RAZORPAY_VERIFY_STATUS_FAIL = "PAYMENT_RAZORPAY_VERIFY_STATUS_FAIL";
