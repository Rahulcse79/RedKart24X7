                    ...
                    <main className="w-full mt-12 sm:mt-0">
                                ...
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    <div className="flex flex-col gap-5 items-start">
                                        ...
                                        <p className="text-gray-600 text-base leading-relaxed">
                                            Welcome to the RedKart24X7 Help Center! Whether you need assistance tracking orders, handling returns and refunds,
                        ...
                        <div className="flex gap-3.5 sm:w-11/12 sm:mt-4 m-auto mb-7">
                            <div className="flex-1 overflow-hidden shadow bg-white rounded-2xl">
                                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                                    <div className="flex flex-col gap-5 items-start">
                                        <span className="font-medium text-2xl">RedKart24X7 Help Centre: Get All Your Shopping Solutions Here</span>
                                        <p>
                                            Once you place an order on any online store, the next step is the excitement of waiting for your product to arrive. At RedKart24X7, we know this wait can sometimes feel uncertain if you don’t receive timely updates or helpful support after your order is placed. That’s exactly why the RedKart24X7 Help Centre is designed to make your experience smooth, easy, and stress-free by offering reliable assistance for all your shopping-related queries.

                                            With RedKart24X7, online shopping has become more convenient than ever. Whether you’re shopping for electronics, fashion, groceries, home essentials, or personal care — everything you need is just a few clicks away. But we also understand that even the smallest issue can turn a great shopping experience into a frustrating one. To ensure that your journey with us stays positive, the RedKart24X7 Help Centre is always ready to assist you — from resolving order-related concerns to helping you manage your returns, payments, and account settings.
                                        </p>
                                    </div>
                                </div>
                            </div>
