...
const SellOnRedKart24X7 = () => {
    ...
    const highlights = [
        {
            icon: "👥",
            title: "1k+ RedKart24X7 Customers",
            highlights: "",
            description: "Join over 1,000 trusted customers who have already chosen RedKart24X7 to grow their businesses. Our platform provides everything you need to succeed online."
        },
        {
            icon: "📞",
    ...
    const sellerStories = [
        { name: "Vinay Garg, Activa & Digi Smart", quote: "Joining RedKart24X7 boosted my business reach. The platform’s payment system and customer support are excellent!", image: "https://via.placeholder.com/80?text=Vinay" },
        { name: "Priya Sharma, Trendy Threads", quote: "RedKart24X7 helped me turn my hobby into a real business. Sales are smooth and customer engagement is fantastic!", image: "https://via.placeholder.com/80?text=Priya" },
        { name: "Rohit Mehra, Home Essentials", quote: "Thanks to RedKart24X7, my small home decor store now reaches customers all over India.", image: "https://via.placeholder.com/80?text=Rohit" },
        { name: "Anjali Patel, Craft Corner", quote: "I started with zero knowledge, but RedKart24X7’s seller support made it easy to grow.", image: "https://via.placeholder.com/80?text=Anjali" },
        { name: "Aman Verma, TechBuzz", quote: "Tech sales skyrocketed after I joined RedKart24X7. The interface is clean and seller-friendly.", image: "https://via.placeholder.com/80?text=Aman" },
        { name: "Sneha Jain, Ethnic Wears", quote: "My ethnic fashion brand found its audience faster than I imagined, thanks to RedKart24X7.", image: "https://via.placeholder.com/80?text=Sneha" },
        ...
        { name: "Pooja Kaur, Kitchen Karma", quote: "My kitchenware brand became a household name with the help of RedKart24X7's wide reach.", image: "https://via.placeholder.com/80?text=Pooja" },
        { name: "Ramesh Bhatia, Daily Needs Mart", quote: "RedKart24X7 made local delivery and customer management super easy for my grocery store.", image: "https://via.placeholder.com/80?text=Ramesh" },
        { name: "Neha Khanna, Decor Dreams", quote: "Decor Dreams scaled from 10 orders a month to 500+ after joining RedKart24X7!", image: "https://via.placeholder.com/80?text=Neha" }
    ];

    const ReadItems = [
        {
            name: "Create Account",
            text: `Create Your RedKart24X7 Seller Account
    Starting your journey as a seller on RedKart24X7 is simple, fast, and hassle-free! Setting up your account takes less than 10 minutes — and you only need 3 basic documents to begin.
    
    We’ve created an easy-to-follow checklist to help you prepare. With your documents ready, you’ll breeze through the setup and unlock the opportunity to showcase your products to thousands of eager shoppers on RedKart24X7.
    
    Don’t wait — join the growing community of sellers, grow your business, and reach new customers with RedKart24X7’s trusted and secure platform.
    
    ✅ Fast registration
    ✅ Only 3 documents required
    ✅ No hidden fees — only growth opportunities!
    
    Get started today and turn your products into profits with RedKart24X7 — where online selling becomes easy and rewarding.`
        },
        {
            name: "List Products",
            text: `List Your Products — Make Them Shine on RedKart24X7
    What is product listing?
    Listing is the process of adding your products to RedKart24X7’s marketplace, making them visible and accessible to millions of potential customers. This step involves creating a detailed and attractive product page that showcases your items with essential information like the product title, description, images, pricing, and specifications.
    
    A well-structured and complete listing not only builds trust but also increases the chances of your product being discovered and purchased on RedKart24X7.
    
    💡 Pro Tip: Sellers who upload clear, high-quality images and write accurate, detailed descriptions see up to 15% more visibility and engagement from customers on RedKart24X7.`
        },
        {
            name: "Storage & Shipping",
            text: `At RedKart24X7, we make sure your products not only reach the right customer but arrive safe and on time. Whether you manage your own inventory or use our trusted fulfillment network, we’ve designed flexible storage and shipping solutions to help your business grow smoothly.
    ...
    📦 Why choose RedKart24X7 for storage & shipping?
    ...
    Storage options: Whether you store products yourself or choose RedKart24X7 warehousing, your inventory is always ready for dispatch.
    
    Focus on growing your brand while we handle the heavy lifting.
    RedKart24X7’s storage and shipping service makes sure your products are always on the move — from your store to your customer’s doorstep.`
        },
        {
            name: "Receive Payments",
            text: `Receive Payments — Fast, Secure & Transparent
    At RedKart24X7, we believe your hard work deserves a smooth and reliable payout process. As soon as you make a sale, our system ensures that your payments are processed quickly, securely, and without unnecessary delays.
    ...
    💸 Why RedKart24X7 payment system stands out?
    ...
    With RedKart24X7, your focus stays on selling, while we take care of ensuring your earnings reach you on time — without the guesswork.`
        },
        {
            name: "Grow Faster",
            text: `Grow Faster with RedKart24X7 — Your Success, Our Mission
    At RedKart24X7, we don’t just help you set up shop — we empower your business to scale and thrive in the digital marketplace. Whether you’re a new seller or an experienced entrepreneur, our platform offers the tools and insights you need to grow your brand and boost your sales.
    
    🚀 Why sellers grow faster on RedKart24X7?
    ...
    Join RedKart24X7 today and transform your small shop into a growing online brand. The faster you start, the sooner you sell — and the higher you soar.`
        },
        {
            name: "Seller App",
            text: `Seller App — Manage Your Shop Anytime, Anywhere!
    Running your online store is now as easy as using your phone! With the RedKart24X7 Seller App, you can stay connected to your business whether you're at home, in the office, or on the go.
    
    📱 Why choose the RedKart24X7 Seller App?
    ...
    The RedKart24X7 Seller App puts your entire shop in your pocket, so you’re always in control — no matter where life takes you.`
        },
        {
            name: "Help & Support",
            text: `Help & Support — We're Here for You, Always!
    At RedKart24X7, your success is our priority. Whether you're setting up your store, managing orders, or scaling your business — our dedicated support team is always ready to help you at every step.
    
    💡 How RedKart24X7 Supports You:
    ...
    Your journey with RedKart24X7 isn’t just about selling — it’s about growing confidently, knowing help is always just a click away.`
        }
    ];
    ...
    return (
        <>
            <MetaData title="Sell on RedKart24X7" />
            {loading ? <Loader /> : (
                <>
                    <MinCategory />
                    ...
                    <main className="w-full mt-12 sm:mt-0 flex flex-col items-center bg-white">
                                            ...
                                            <div className="flex flex-col justify-between h-full p-6 sm:p-8">
                                                <div className="flex flex-col gap-5 items-start">
                                                    {selectedItemOFCard ? (
                                                        ...
                                                        <span className="font-medium text-2xl text-center text-gray-600">Sell Online with RedKart24X7!</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex flex-col justify-between h-full m-4 sm:mx-8 sm:my-6">
                                        <div className="flex flex-col gap-5 items-start">
                                            {selectedItem ? (
                                                ...
                                                <span className="font-medium text-2xl">Sell Online with RedKart24X7 !</span>
                                            )}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section className="bg-blue-50 py-10 text-center w-full">
                            ...
                            <p className="text-gray-600 mt-2">Join RedKart24X7 today and unlock your business growth!</p>
                        ...
                        <section className="p-8 text-center text-gray-500 text-sm">
                            <p>RedKart24X7 is here to empower small and large businesses alike. Start your journey today!</p>
                        </section>
...
export default SellOnRedKart24X7;
