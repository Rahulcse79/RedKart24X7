...
import { clearErrors, loadSeller, updateProfile } from '../../actions/SellerAction';
import { UPDATE_PROFILE_RESET } from '../../constants/SellerConstants';
...
const SellerUpdateProfile = () => {
    ...
    const { error, isUpdated, loading } = useSelector((state) => state.profileSellerReducer);
    ...
    useEffect(() => {
        ...
        if (isUpdated) {
            enqueueSnackbar("Seller profile Updated Successfully", { variant: "success" });
            dispatch(loadSeller());
            navigate('/seller/dashboard');

            dispatch({ type: UPDATE_PROFILE_RESET });
        }
    }, [dispatch, error, seller, isUpdated, navigate, enqueueSnackbar]);
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    <div className="loginSidebar bg-primary-blue px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        <h1 className="font-medium text-white text-3xl">Seller update Profile !</h1>
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <Link className="hover:bg-gray-100 text-primary-blue text-center py-3 w-full shadow border rounded-sm font-medium" to="/seller/dashboard">Cancel</Link>
                            </div>
                        </form>
                    </div>
                </div>
